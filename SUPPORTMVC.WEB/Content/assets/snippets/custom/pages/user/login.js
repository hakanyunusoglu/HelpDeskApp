var SnippetLogin = function () {
    ...
    return {
        init: function () {
            ...
            }), $("#btnsifremiunuttumgonder").click(function (l) {
                l.preventDefault();
                var t = $(this),
                    r = $(this).closest("form");
                r.validate({
                    ...
                    success: function (l, s, n, o) {
                        setTimeout(function () {
                            t.removeClass("m-loader m-loader--right m-loader--light").attr("disabled", !1), r.clearForm(), r.validate().resetForm(), a();
                            var l = e.find(".m-login__signin form");
                            l.clearForm(), l.validate().resetForm(), i(l, "success", "Şifre yenileme talebiniz alınmıştır. E-posta adresinizi kontrol edin!")
                        }, 2e3)
                    }
                }))
            })
